...
class sem_widgets {
	...
	**/
	...
	function register() {
		...
		register_widget('header_section');
		register_widget('header_section_2');
		register_widget('header_section_3');
		register_widget('header_section_4');
		register_widget('footer_section');
		register_widget('footer_section_2');
		register_widget('footer_section_3');
		register_widget('footer_section_4');
